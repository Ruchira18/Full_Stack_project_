...
<h2 style="color:#36486b"><center>WITHDRAW AMOUNT</center></h2>
<%

%>
<form action="decreaseAmount" method="get"><center>
    ...
    Enter Amount for Withdraw:<br><input type="text" name="Amount"><br><br>
